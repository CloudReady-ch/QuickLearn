...
## Client OneDrive
Avec Windows 10, le client OneDrive est inclus. Il permet d'assurer une copie locale et il est possible de s'en passer, mais c'est dommage. Même 5GB gratuit permettent de sauvegarder très facilement les fichiers bureautiques de plusieurs années, d'une personne...
Il est aussi possible d'avoir une version sur tablette ou mobile (smartphone), ou Macintosh (MacOS)
...
### QuickLearn
* [Partages OneDrive et Teams](https://medium.com/quicklearn/partages-onedrive-teams-onenote-1489cd5febde)
### Articles
